...
namespace Sokszogek.ViewModels
{
    ...
    // Ez az osztály valósítja meg INotifyPropertyChanged interfészt, az egyirányú és kétirányú kötések támogatására 
    // (olyan, hogy az UI elem frissüljön, amikor a forrás dinamikusan módosul)
